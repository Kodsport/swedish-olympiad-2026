...
She can open and close doors as she wishes, with one constraint:
each door is linked with exactly one other door.
...
A door cannot be linked with more than one other door.

Since the control panel is in her office in room $1$, she must decide which corridors to open before leaving the office.
