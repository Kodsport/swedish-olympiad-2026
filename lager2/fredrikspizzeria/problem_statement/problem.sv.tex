...
På grund av brandsäkerhet är det även garanterat att varje korridor ingår i som mest en cykel\footnote{Definitionen av en cykel med $k$ rum är en sekvens rum $c_1, c_2, \dots, c_k$, där alla $c_i$ är parvis unika och det finns en korridor mellan $c_i$ och $c_{i+1}$. Notera att det även måste finnas en korridor mellan $c_k$ och $c_1$.}.

\section*{Indata}
Den första raden av indata innehåller heltalen $N$ och $M$ ($3 \leq N,M \leq 2 \cdot 10^5$),
...
vilket betyder att det finns en korridor mellan rum $u$ och $v$, och att denna korridoren är sammanlänkad med korridoren med nummer $l$.
