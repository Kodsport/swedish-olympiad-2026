...
varje dörr är sammanlänkad med \textbf{exakt} en annan dörr.
...
Att dörrar är sammanlänkade med varandra är symmetriskt, vilket innebär att om dörr $a$ är sammanlänkad med dörr $b$, så är dörr $b$ sammanlänkad med dörr $a$.

Eftersom kontrollpanelen finns i hennes kontor i rum $1$, så måste hon bestämma vilka korridorer hon ska öppna eller stänga innan hon lämnar kontoret.
...
I exempelfall $1$ går det inte eftersom de enda korridorerna mellan utgången och råttan är sammanlänkade.
