...
\section*{Indata}
Den första raden innehåller tre heltal $N$, $a$ och $b$ ($1 \leq N \leq 5 \cdot 10^5$, $0 \leq a,b \leq 10^9$).
...
\begin{tabular}{| l | l | p{12cm} |}
  ...
  $5$    & $9$         & $b = 0$ \\ \hline
  $6$    & $8$         & $a = 10^9, b = 1$, det finns lika många \texttt{(} som \texttt{)} i indatasträngen. \\ \hline
  $7$    & $5$         & $a = 10^9, b = 1$ \\ \hline
  $8$    & $11$        & Inga ytterligare begränsningar. \\ \hline
\end{tabular}
