...
För att beräkna saker har du ett kluster av svampar: $N$ stycken svampar numrerade från $1$ till $N$.
...
\texttt{\makebox[2em][l]{< j:}}           & A[i] & = & P[j]\ \texttt{<<}\ 1 & & \quad \text{där \texttt{<<} betecknar vänsterskift.} \\
\texttt{\makebox[2em][l]{> j:}}           & A[i] & = & P[j]\ \texttt{>>}\ 1 & & \quad \text{där \texttt{>>} betecknar högerskift.} \\
...
Se till att läsa beskrivningen av operationerna noggrant.

Du får nu $N$ vikter $w_1, w_2, \dots, w_N$ och behöver hitta en sekvens rundor som får $A[i]=w_i$ för alla $i$.

Desto färre rundor du använder, desto mer poäng får du. I testdatan är $N$ alltid $512$.
