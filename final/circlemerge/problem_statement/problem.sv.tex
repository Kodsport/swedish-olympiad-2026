...
Emil har $N$ påsar av stenar placerade i en cirkel. 
I varje påse finns ett antal stenar, där antalet i påse $i$ är $a_i$ för $1 \leq i \leq N$. 
Påsarna är ordnade enligt en cirkeln, så att påse $1$ är intill påse $2$ och $N$, påse $2$ är intill påse $1$ och $3$, \dots, och påse $N$ är intill påse $N-1$ och $1$.
