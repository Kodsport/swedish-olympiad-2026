...
Positionerna mellan gängets nuvarande position och Strongholds position kan modelleras på en tallinje, 
där Harrys gäng just nu befinner sig vid position $0$, och Stronghold är beläget vid position $S$.

I Minecraft finns två världar: \textit{Overworld} och \textit{Nether}. Harrys gäng och Stronghold befinner sig i Overworld.
...
Vad är det minsta antalet sekunder det kan ta för Harrys gäng att nå Stronghold från position $0$ i Overworld?
...
Vi set att det snabbaste sättet att nå Stronghold är att gå
\begin{itemize}
  ...
  \item och slutligen gå från position $32$ i Overworld till Stronghold vid position $41$ (tar $9$ sekunder).
\end{itemize}
