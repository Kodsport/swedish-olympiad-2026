...
Harry och hans vänner har på sistone börjar spela Minecraft tillsammans, och försöker klara av spelet så snabbt som möjligt tillsammans.

Nu har Harrys gäng lyckats samla ihop alla resurser de behöver för att nå \textit{The Stronghold}, där man behöver nå för att spelet ska kunna avslutas.

Positionerna mellan gängets nuvarande position och The Strongholds position kan modelleras på en tallinje, 
där Harrys gäng befinner just nu sig vid position $0$, och The Stronghold befinner sig vid position $S$.
...
För att kunna använda portal $i$ måste den först repareras, vilket tar $t_i$ sekunder. Om gänget väljer att faktiskt använda portalen
(med andra ord gå igenom den) krävs dessutom ytterligare $t_i$ tid för att förbereda och aktivera den. 
...
Vi set att det snabbaste sättet att nå The Stronghold är att gå
\begin{itemize}
  ...
  \item sedan gå till position $4$ in nether (tar $2$ sekunder),
  \item reparera portal $4$ och gå igenom den portalen (tar $t_4 = 5$ sekunder),
