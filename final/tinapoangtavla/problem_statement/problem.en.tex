...
ICPC is a programming contest where teams have five hours to solve as many problems as possible.
The rules in this problem are similar, but not exactly the same as official ICPC.

In this contest, you don't get points for each submission; instead, a submission is either
\textit{Accepted} or \textit{Wrong Answer}.
...
\section*{Explanation of the sample cases}
