...
ICPC är en programmeringstävling där man får fem timmar på sig att lösa så många problem som möjligt. Reglerna i det här problemet är liknande, men inte exakt samma som officiella ICPC.
I denna tävling får man inte poäng per inskick, utan antingen får man \textit{Accepted} eller \textit{Wrong Answer}.
...
Notera att om ett lager aldrig löser ett visst problem under hela tävlingen, så får de inget inskicks-straff från det problemet.
...
($1 \leq N, F \leq 2 \cdot 10^5$, $0 \leq H \leq 2 \cdot 10^5$, $1 \leq P \leq 15$),
...
Dessa inskick är ordnade i kronologisk ordning, det vill säga är de sorterade på $t$.
...
Dessa är givna i ordningen som Lidia undrar om.
