...
Människorna är numrerade $1$ till $M$ och husen $1$ till $N$.
...
Likaså känner person $M$ person $M-1$ och person $1$.
Med andra ord formar grafen av vänskaper en cykel.

För att en fest ska ske måste först en person $p$ ställa upp som värd.
Den personen bestämmer först hur rolig festen ska vara, vilket vi betecknar med $R$.
...
Denna processen fortsätter tills exakt $K$ personer är inbjudna, inklusive värden.
...
\section*{Indata}
Den första raden av indata innehåller heltalen $N$, $M$ och $Q$ ($1 \leq N, Q \leq 10^5$, $3 \leq M \leq N$),
...
\begin{tabular}{| l | l | p{12cm} |}
  ...
  $4$    & $15$  & $r_1=1$ och $r_i=i-1$ för alla $i \geq 2$. Med andra ord utgör trädet en linje. \\ \hline
  $5$    & $12$  & $R=1$ för alla frågor. \\ \hline
  $6$    & $20$  & $M \leq 100$ \\ \hline
  $7$    & $5$   & $N,M,Q \leq 25{,}000$ \\ \hline
...
\begin{itemize}
  ...
  Det går däremot inte att bjuda in person $1$ och $2$, eftersom det inte finns ett möjligt festhus.
  \item I sed $2$ kan man inte bjuda in mer än person $2$. Därmed består festen av person $2$ i hus $6$.
  ...
  \item I sed $7$ går det att utföra en fest där alla är bjudna med festhus $2$.
\end{itemize}
