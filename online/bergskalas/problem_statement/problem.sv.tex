...
Vissa hus kan stå tomma, men varje person bor i ett hus.
Eftersom det tar lång tid promenera i berget finns det en rutschkana från varje hus till ett hus längre ner i berget (förutom huset längst ner).

Uppe på ett berg finns det inte så mycket att göra, så byborna har hittat på seder.
Dessa har blivit så konstiga att byborna behöver din hjälp för att kunna fortsätta med sederna.
...
Den andra raden innehåller $N$ heltal $r_1, \dots, r_N$ ($0 \leq r_i \leq N$),
där $r_i$ betyder att hus $i$ har en rutschkana till hus $r_i$.
Det finns exakt ett hus som har $r_i=0$, och detta betyder att detta huset är längst ner och inte har en rutschkana.
...
De följande $M$ raderna beskriver vänskaperna. Den $i$:te av dessa rader innehåller heltalen $a$ och $b$ ($1 \leq a,b \leq M$, $a \neq b$),
vilket betyder att person $i$ är vän med person $a$ och $b$.
