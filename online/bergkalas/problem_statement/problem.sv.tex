...
Detta är cykliskt, så i synnerhet känner person $1$ och $M$ varandra.
...
\section*{Indata}
Den första raden av indata innehåller heltalen $N$, $M$ och $Q$ ($1 \leq N, M, Q \leq 10^5$),
