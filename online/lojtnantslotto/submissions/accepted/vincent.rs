...
/**
 * Url: https://github.com/rust-lang/rustc-hash/blob/5e09ea0a1c7ab7e4f9e27771f5a0e5a36c58d1bb/src/lib.rs
 * Licence: MIT/Apache License 2.0
 * Date: 2024-05-31
 * 
...
fn main() {
    ...
    for sell_i in 0..5 {
        ...
        let rem = (7-sell_i as u32).min(count);
        copy[sell_i] -= rem;
