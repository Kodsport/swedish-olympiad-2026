...
\section*{Input}
The input consists of two integers $N$ and $Q$ ($1 \le N, Q \le 2 \cdot 10^{5}$). All $N$ seats are initially available.
...
\begin{itemize}
  \item Print \texttt{Ledig} if the target seat was available (and perform the change).
  \item Otherwise print \texttt{Upptagen}.
\end{itemize}
