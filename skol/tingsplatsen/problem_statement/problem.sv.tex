...
ett antal gårdar som fanns i området, och har kommit fram till att tingsplatsen måste ligga på ungefär samma avstånd
...
De följande $N$ rutorna innehåller vardera en sträng av längd $M$, som består av tecknen ``\verb|.|'' och ``\verb|*|''.
