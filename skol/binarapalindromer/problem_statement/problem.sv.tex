...
Mikael studerar intressanta positiva heltal, och vill nu undersöka tal som är ett \emph{binärt palindrom}. För att formellt beskriva detta
definierar vi följande funktioner:
