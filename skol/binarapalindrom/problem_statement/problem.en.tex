...
Mikael is investigating interesting positive integers, and has now stumbled upon \emph{binary palindromes}. 
...
Mikael likes the binary palindromes that contain exactly $k$ ones in their binary representation, 
