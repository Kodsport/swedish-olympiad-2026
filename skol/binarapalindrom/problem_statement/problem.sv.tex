...
Mikaela är särskilt intresserad av de binära palindrom som innehåller exakt $k$ ettor i sin binära representation,
...
\begin{enumerate}
    ...
    \item Talet $x$ är ett binärt palindrom,
...
\section*{Utdata}
Skriv ut ett heltal: antalet heltal i intervallet $[l, r]$ som är ett binärt palindrom och har exakt $k$ ettor i sin binära representation.
...
I exempelfall $1$ söker vi tal i intervallet $[7, 10]$ som både är ett binärt palindrom och har exakt två ettor i sin binära representation.
...
I exempelfall $2$ söker vi tal i intervallet $[1, 6]$ som både är ett binärt palindrom och har exakt två ettor i sin binära representation.
