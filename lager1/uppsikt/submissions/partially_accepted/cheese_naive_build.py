...
def build_cartesian_tree(p):
    ...
    # Iterative: simulate recursive "find max, split" using explicit stack
    # Stack entries: (lo, hi, parent, side) where side: 0=left child, 1=right child
    root = -1
    stack = [(0, n - 1, -1, -1)]
    while stack:
        ...
        if par == -1:
            ...
            right[par] = m
        stack.append((m + 1, hi, m, 1))
        stack.append((lo, m - 1, m, 0))
